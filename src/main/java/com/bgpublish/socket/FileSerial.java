...
public class FileSerial implements Serializable{
	...
	private @Getter @Setter String toUser;    //接收用户 
	private @Getter @Setter String fromUser;  //发送用户 
	
	protected static final int TYPE_ONLINE = -1;// 上线（用户登录上线）
	protected static final int TYPE_OFFLINE = -2;// 下线（用户退出下线）
	protected static final int TYPE_OFFLINE_MSG = -3;// 离线信息（默认打开聊天窗口时加载）
    ...
    protected static final int TYPE_PICTURE = 3;// 图片
}
